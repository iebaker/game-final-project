...
public class Sprite {
	...
	private Hashtable<String, Hashtable<Integer, Vec2i>> _posHash;
	//Hashtable that hashes mode -> number of frames
	private Hashtable<String, Integer> _frameHash;
	private int _tempX;
	private int _x;
	private int _y;
	...
	public Sprite() {
		_posHash = new Hashtable<String, Hashtable<Integer, Vec2i>>();
		_frameHash = new Hashtable<String, Integer>();
	}
