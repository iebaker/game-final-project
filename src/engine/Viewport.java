...
public class Viewport {
	...
	public static float gameFloatToScreen(float toConvert) {
		Vec2f src = Viewport.gamePtToScreen(Vec2f.ZERO);
		Vec2f dest = Viewport.gamePtToScreen(Vec2f.ZERO.plus(toConvert, 0));
		return dest.minus(src).x;
	}
	
	public static float screenFloatToGame(float toConvert) {
		Vec2f src = Viewport.screenPtToGame(Vec2f.ZERO);
		Vec2f dest = Viewport.screenPtToGame(Vec2f.ZERO.plus(toConvert, 0));
		return dest.minus(src).x;
	}
