...
public class Artist {
	 ...
	 * 
	 * @param g
	 *            The graphics2D object which will be used to draw
	 * @param x
	 *            The x position of the bounding rectangle of the ellipse
	 * @param y
	 *            The y position of the bounding rectangle of the ellipse
	 * @param width
	 ...
	 * 
	 * @param g
	 *            the Graphics2D object used to draw
	 * @param img
	 *            the Image to draw
	 * @param x
	 *            the integer x position at which to draw the image.
	 * @param y
	 *            the integer y position at which to draw the image
	 * @param width
	 *            the width of the image to draw (will scale if not the same aspect ratio)
	 * @param height
	 *            the height of the image to draw (will scale if not the same aspect ratio)
	 */
	 ...
	 * 
	 * @param g
	 *            The Graphics2D object which will be used for drawing
	 * @param points
	 *            The list of poings describing the path (in counterclockwise order around the shape)
	 */
	 ...
	 *            The height of the rectangle
	 * @param arcwidth
	 *            The arc width of the corners of the rectangle
	 * @param archeight
	 *            The arc height of the corners of the rectangle
	 */
	 ...
	 * 
	 * @param f
	 *            A boolean -- true if fill should be turned on, false otherwise
	 */
	 ...
	 * 
	 * @param p
	 *            The Paint object to use for filled drawing
	 */
	 ...
	 * 
	 * @param s
	 *            A boolean -- true if stroke should be turned on, false otherwise.
	 */
	 ...
	 * 
	 * @param p
	 *            The Paint object to use for stroke drawing
	 */
