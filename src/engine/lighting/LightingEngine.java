		...
		for (LightSource light : world.getLightSources()) {
			...
			for (Vec2fPair pair : pointPairs) {
				...
				if (comp <= 0) {
					...
					segment.setEndPoint(a); //TODO: From Sawyer: Couldn't you deal with that by doing an extra cast horizontally and orienting everything that it hits correctly
				}
